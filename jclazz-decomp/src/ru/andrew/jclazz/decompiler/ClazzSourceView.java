...
import java.util.*;
import java.io.*;
import ru.andrew.jclazz.decompiler.engine.ClazzContext;
...
public class ClazzSourceView extends SourceView
{
    ...
    public ClazzSourceView(Clazz clazz, ClazzSourceView outerClazz, Map decompileParams)
    {
        super();

        this.context = new ClazzContext();
        this.params = decompileParams;
    ...
    public ClazzContext getContext()
    {
        return context;
    }
        ...
        if (innerClassViews != null)
        {
            for (int i = 0; i < innerClassViews.length; i++)
            {
                ...
                try
                {
                    ...
                    ClazzSourceView innerClassPrinter = new InnerClazzSourceView(innerClazz, this, getDecompileParameters());
                ...
                {
                    pw.println("ERROR: Class " + inname + " not found");
                    getContext().registerError("Class " + inname + " not found");
                }
...
//            println("");
    ...
    public Map getDecompileParameters()
    {
        return params;
    }
