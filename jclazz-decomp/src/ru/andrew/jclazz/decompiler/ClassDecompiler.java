...
{
    public static DecompileResult decompileJavaFile(String in, Map params) throws ClazzException, IOException
    {
        Clazz clazz = new Clazz(in);
        ClazzSourceView csv = ClazzSourceViewFactory.getClazzSourceView(clazz, params);
        ...
        DecompileResult dr = new DecompileResult();
        dr.setOutFile(outFile);
        dr.setErrors(csv.getContext().getErrors());
        return dr;
    }

    public static String generateJavaFile(String in, Map params) throws ClazzException, IOException
    {
        DecompileResult dr = decompileJavaFile(in, params);
        return dr.getOutFile();
    }
